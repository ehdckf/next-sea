...
var app = (0, next_1.default)({ dev: false, hostname: hostname, port: port, dir: __dirname, conf: { output: "standalone" } });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    console.log("ssssss");
                    return [2 /*return*/, new Response("HELLO")];
                case 5: return [4 /*yield*/, handle(req, res, parsedUrl)];
                case 6:
                    _a.sent();
                    _a.label = 7;
